...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      livereload: {
        files: [
          '{.tmp,<%= yeoman.client %>}/{app,components,blog}/**/*.css',
          '{.tmp,<%= yeoman.client %>}/{app,components,blog}/**/*.html',
          '{.tmp,<%= yeoman.client %>}/blog/**/*.js',
    ...
    jshint: {
      ...
      all: [
        ...
        '!<%= yeoman.client %>/{app,components}/**/*.spec.js',
        '!<%= yeoman.client %>/{app,components}/**/*.mock.js',
        '!<%= yeoman.client %>/components/vendor/**/*.js',
        '!<%= yeoman.client %>/app/translations.js'
      ],
      test: {
        src: [
          '<%= yeoman.client %>/{app,components}/**/*.spec.js',
    ...
    autoprefixer: {
      options: {
        browsers: ['last 2 version', 'ff > 20', 'ie >= 10']
      },
      dist: {
        files: [{
          expand: true,
        ...
        files: {
          'server/views/index.html': [
               [
                 ...
                 '!{.tmp,<%= yeoman.client %>}/app/forgeso.js',
                 '!{.tmp,<%= yeoman.client %>}/app/nova.js',
